...
document.addEventListener('DOMContentLoaded', function(){
	...
	class FlameAnimation {
		...
		setWaves(){
			...
			let o1 = new OffsetCount(0.05), o2 = new OffsetCount(0.03), o3 = new OffsetCount(0.06),  // new position for vert
					o4 = new OffsetCount(0.08), o5 = new OffsetCount(0.04), o6 = new OffsetCount(0.067); // new position for hori
